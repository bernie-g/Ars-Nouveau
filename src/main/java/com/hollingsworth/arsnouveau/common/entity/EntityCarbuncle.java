...
public class EntityCarbuncle extends CreatureEntity implements IAnimatable
{
	...
	AnimationController<EntityCarbuncle> walkController = new AnimationController(this, "walkController", 20, this::animationPredicate);
	AnimationController<EntityCarbuncle> idleController = new AnimationController(this, "idleController", 20, this::idlePredicate);
